...
"background-color: rgb(50, 50, 50);")
    ...
    def retranslateUi(self, UE_input_Dialog):
        ...
        self.Check_asset.setWhatsThis(QtWidgets.QApplication.translate("UE_input_Dialog", "<html><head/><body><p>预先检测所选中需要导入UE的FBX文件是否存在相对应的UE4骨架资产，如果缺失相应资产则会导致导入动画失败。</p></body></html>", None, -1))
        self.Check_asset.setText(QtWidgets.QApplication.translate("UE_input_Dialog", "CheckAsset", None, -1))
        self.Delete_ue_ani.setWhatsThis(QtWidgets.QApplication.translate("UE_input_Dialog", "<html><head/><body><p>是否要删除与所选镜头相对应的UE4镜头文件内的动画文件。</p></body></html>", None, -1))
