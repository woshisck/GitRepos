...
class QFileDialog(PySide2.QtWidgets.QDialog):
    ...
    @staticmethod
    def getOpenFileUrls(parent:PySide2.QtWidgets.QWidget=..., caption:str=..., dir:PySide2.QtCore.QUrl=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=..., supportedSchemes:typing.List=...) -> typing.List: ...
    @staticmethod
...
class QMenu(PySide2.QtWidgets.QWidget):
    ...
    @typing.overload
    @staticmethod
    def exec_(actions:typing.List, pos:PySide2.QtCore.QPoint, at:PySide2.QtWidgets.QAction=..., parent:PySide2.QtWidgets.QWidget=...) -> PySide2.QtWidgets.QAction: ...
    @typing.overload
    @staticmethod
